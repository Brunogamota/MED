...
/**
 * Calendario do sistema, sobre o react-day-picker.
 *
 * Locale pt-BR por padrao: a semana comeca no domingo, o mes vem por extenso
 * em portugues e o dia da semana sai abreviado como o operador escreve. Quem
 * precisar de outro locale passa `locale` — o `...props` vence o padrao.
 */
...
export function Calendar({
  ...
  const dayPickerProps = {
    ...
    'data-slot': 'calendar',
    formatters: {
      formatMonthDropdown: (date: Date) => date.toLocaleString('pt-BR', { month: 'short' }),
