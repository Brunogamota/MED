    ...
    groups: [
      {
        ...
        items: [
          { id: 'todas', label: 'Todas as fontes', icon: Flash, href: '/integracoes' },
          {
            ...
            label: 'Gateways Pix',
            icon: Wallet,
            href: '/integracoes#gateways-pix',
          },
          {
            id: 'digital',
            label: 'Venda digital',
            icon: ShoppingCart,
            href: '/integracoes#plataformas-de-venda-digital',
          },
          {
            id: 'membros',
            label: 'Áreas de membros',
            icon: UserMultiple,
            href: '/integracoes#areas-de-membros',
          },
          {
            id: 'ecommerce',
            label: 'E-commerce',
            icon: ShoppingCart,
            href: '/integracoes#e-commerce',
          },
          {
            id: 'genericos',
            label: 'Genéricos',
            icon: Table,
            href: '/integracoes#genericos',
          },
        ],
      },
    ],
